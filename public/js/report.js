$(document).ready(function() {
    ...
    sell_payment_report = $('table#sell_payment_report_table').DataTable({
        ...
        ajax: {
            ...
            data: function(d) {
                ...
                d.created_by_user_id = $('select#created_by_user_id').val();
                var start = '';
                var end = '';
        ...
        columns: [
            ...
            { data: 'amount', name: 'transaction_payments.amount' },
            { data: 'customer', orderable: false, searchable: false },
            { data: 'created_by_user', name:'cf.name' },
    ...
    $('#sell_payment_report_form #location_id, \
      #sell_payment_report_form #customer_id, \
      #sell_payment_report_form #payment_types, \
      #sell_payment_report_form #customer_group_filter, \
      #sell_payment_report_form #created_by_user_id'   // <-- NUEVO
    ).change(function() {
      sell_payment_report.ajax.reload();
    });
