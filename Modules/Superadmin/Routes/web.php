...
Route::middleware('web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->group(function () {
    ...
    Route::post('/capture-mercadopago-payment', [Modules\Superadmin\Http\Controllers\SubscriptionController::class, 'captureMercadoPagoPayment'])->name('captureMercadoPagoPayment');
