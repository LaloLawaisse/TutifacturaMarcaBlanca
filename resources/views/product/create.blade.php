...
<section class="content">
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('name', __('product.product_name') . ':*', ['class' => 'simple_text']) !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('sku', __('product.sku') . ':', ['class' => 'simple_text']) !!} @show_tooltip(__('tooltip.sku'))
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('barcode_type', __('product.barcode_type') . ':*', ['class' => 'simple_text']) !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('unit_id', __('product.unit') . ':*', ['class' => 'simple_text']) !!}
        ...
        <div class="col-sm-4 @if(!session('business.enable_sub_units')) hide @endif">
            <div class="form-group">
                {!! Form::label('sub_unit_ids', __('lang_v1.related_sub_units') . ':', ['class' => 'simple_text']) !!} @show_tooltip(__('lang_v1.sub_units_tooltip'))
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('secondary_unit_id', __('lang_v1.secondary_unit') . ':', ['class' => 'simple_text']) !!} @show_tooltip(__('lang_v1.secondary_unit_help'))
        ...
        <div class="col-sm-4 @if(!session('business.enable_brand')) hide @endif">
            <div class="form-group">
                {!! Form::label('brand_id', __('product.brand') . ':', ['class' => 'simple_text']) !!}
                <div class="input-group">
        ...
        <div class="col-sm-4 @if(!session('business.enable_category')) hide @endif">
            <div class="form-group">
                {!! Form::label('category_id', __('product.category') . ':', ['class' => 'simple_text']) !!}
        ...
        <div class="col-sm-4 @if(!(session('business.enable_category') && session('business.enable_sub_category'))) hide @endif">
            <div class="form-group">
                {!! Form::label('sub_category_id', __('product.sub_category') . ':', ['class' => 'simple_text']) !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('product_locations', __('business.business_locations') . ':', ['class' => 'simple_text']) !!} @show_tooltip(__('lang_v1.product_location_help'))
        ...
        <div class="col-sm-4 @if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0) hide @endif" id="alert_quantity_div">
            <div class="form-group">
                {!! Form::label('alert_quantity', __('product.alert_quantity') . ':', ['class' => 'simple_text']) !!} @show_tooltip(__('tooltip.alert_quantity'))
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('warranty_id', __('lang_v1.warranty') . ':', ['class' => 'simple_text']) !!}
        ...
        <div class="col-sm-8">
            <div class="form-group">
                {!! Form::label('product_description', __('lang_v1.product_description') . ':', ['class' => 'simple_text']) !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('image', __('lang_v1.product_image') . ':', ['class' => 'simple_text']) !!}
    ...
    <div class="col-sm-4">
        <div class="form-group">
            {!! Form::label('product_brochure', __('lang_v1.product_brochure') . ':', ['class' => 'simple_text']) !!}
    ...
    <div class="row">
        ...
        <div class="col-sm-4 @if($hide) hide @endif">
            <div class="form-group">
                <div class="multi-input">
                    {!! Form::label('expiry_period', __('product.expires_in') . ':', ['class' => 'simple_text']) !!}<br>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                {!! Form::label('rack_' . $id, $location . ':', ['class' => 'simple_text']) !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('weight', __('lang_v1.weight') . ':', ['class' => 'simple_text']) !!}
        ...
        @foreach($product_custom_fields as $index => $cf)
            @if(!empty($cf))
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        {!! Form::label($db_field_name, $cf . ':', ['class' => 'simple_text']) !!}
    ...
    <div class="row">
        ...
        <div class="col-sm-4 @if(!session('business.enable_price_tax')) hide @endif">
            <div class="form-group">
                {!! Form::label('tax', __('product.applicable_tax') . ':', ['class' => 'simple_text']) !!}
                {!! Form::select(
                    'tax',
                    [
                        0 => 'Sin impuesto (0%)',
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('type', __('product.product_type') . ':*', ['class' => 'simple_text']) !!} @show_tooltip(__('tooltip.product_type'))
...
$(function () {
    ...
    function parseNumber(val) {
        ...
        // formato ES (puntos miles, coma decimal)
    ...
    // Eventos
    $sellPriceExcl.on('input blur', updateSellingPriceWithTax);
    $taxSelect.on('change select2:select', updateSellingPriceWithTax);

    // Inicial
    updateSellingPriceWithTax();
});
</script>
