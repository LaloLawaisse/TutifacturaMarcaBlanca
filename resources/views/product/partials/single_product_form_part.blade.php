...
<div class="table-responsive">
    <table class="table table-bordered add-product-price-table table-condensed {{$class}}">
        <tr>
          <th class="simple_text">@lang('product.default_purchase_price')</th>
          <th class="simple_text">@lang('product.profit_percent') @show_tooltip(__('tooltip.profit_percent'))</th>
          <th class="simple_text">@lang('product.default_selling_price')</th>
          @if(empty($quick_add))
            <th class="simple_text">@lang('lang_v1.product_image')</th>
          @endif
        </tr>
        <tr>
          <td>
