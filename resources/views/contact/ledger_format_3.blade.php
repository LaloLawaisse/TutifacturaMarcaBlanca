...
@php
    $advance_balance = $contact->balance - $ledger_details['total_reverse_payment'];
    $balance_due = $ledger_details['balance_due'] - $ledger_details['ledger_discount'];
    $has_to_pay = $advance_balance > 0 ? $balance_due - $advance_balance : $balance_due;
@endphp

<tr>
    <td>@lang('lang_v1.advance_balance')</td>
    <td class="align-right">@format_currency($advance_balance)</td>
</tr>

<tr>
    <td><strong>@lang('lang_v1.balance_due')</strong></td>
    <td class="align-right">@format_currency($balance_due)</td>
</tr>

<tr>
    <td><strong>Has to pay</strong></td>
    <td class="align-right">@format_currency(abs($has_to_pay))</td>
</tr>
