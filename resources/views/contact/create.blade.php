        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::text('cuit_number', null, ['class' => 'form-control', 'placeholder' => 'Ingrese CUIT', 'id' => 'cuit_number']) !!}
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::text('document_type', null, ['class' => 'form-control', 'readonly' => true, 'id' => 'document_type']) !!}
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        ], null, ['class' => 'form-control select2', 'id' => 'tax_category']) !!}
                    </div>
                </div>
