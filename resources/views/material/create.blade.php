...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">Agregar insumo</h1>
    
    @include('layouts.partials.error')
</section>

<section class="content">
    {!! Form::open(['url' => route('materials.store'), 'method' => 'post', 'id' => 'material_add_form']) !!}
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    {!! Form::number('unidades_en_stock', 0, ['class' => 'form-control', 'min' => 0]) !!}
                </div>
            </div>
