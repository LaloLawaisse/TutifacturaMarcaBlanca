    ...
    <section class="content no-print">
        ...
        @component('components.widget', ['class' => 'box-solid'])
            ...
            <div class="col-sm-12 text-center" style="margin-top: 20px">
                ...
                <button type="button" onclick="window.open('https://www.gestionenorden.com/woocommerce', '_blank')"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="authSectionML" style="display: none;">
                        ...
                        <a href="https://auth.mercadolibre.com.ar/authorization?response_type=code&client_id=776528488475123&redirect_uri=https://www.gestionenorden.com/callback/"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="authSectionMP" style="display: none;">
                        ...
                        <a href="https://auth.mercadopago.com.ar/authorization?response_type=code&client_id=6815763552830505&redirect_uri=https://www.gestionenorden.com/callbackMP/"
                           class="btn btn-warning btn-block" target="_blank">
                            Autorizar aplicación
                        </a>
                    </div>
