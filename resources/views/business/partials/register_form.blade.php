...
<div class="col-md-6">
    ...
    <div class="input-group">
        ...
        {!! Form::select(
            'currency_id', 
            $currencies, 
            4, // Valor predefinido (ID de Argentina - Pesos)
            [
...
<div class="col-md-6">
    <div class="form-group">
    {!! Form::label('mobile', __('Numero de Whatsapp') . ':*') !!}
    <div class="input-group">
        <span class="input-group-addon">
...
<div class="col-md-6">
    ...
    <div class="input-group">
        ...
        {!! Form::text('country', 'Argentina', ['class' => 'form-control', 'placeholder' => __('business.country'), 'required']); !!}
    </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::select(
                'time_zone', 
                $timezone_list, 
                'America/Argentina/Buenos_Aires', // Valor predeterminado
                [
                    'class' => 'form-control select2_register', 
...
@if(empty($is_admin))
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('tax_number_1', __('CUIT') . ':') !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-info"></i>
                </span>
                {!! Form::number('tax_number_1', null, ['class' => 'form-control', 'min' => '0', 'step' => '1']); !!}
            </div>
        </div>
    </div>
    <div class="clearfix"></div>
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('tax_number_2',__('DIRECCION') . ':') !!}
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-info"></i>
                </span>
...
<style>
    #business_register_form .steps li {
        font-size: 18px;
        text-align: center;
        padding: 10px 15px;
        list-style: none;
        display: inline-block;
        width: 25%; /* Distribuye uniformemente cada paso */
        box-sizing: border-box;
        border-bottom: 2px solid #ccc;
    }
    
    #business_register_form .steps li.current {
        font-weight: bold;
        color: #007bff;
    ...
    @media (max-width: 768px) {
        #business_register_form .steps li {
            font-size: 16px;
            padding: 8px;
            width: 50%; /* Reduce el ancho para pantallas más pequeñas */
        }
    }
    ...
    @media (max-width: 480px) {
        #business_register_form .steps li {
            font-size: 14px;
            width: 100%; /* Cada paso ocupa una línea completa */
            padding: 6px;
            text-align: left;
        }
    }
