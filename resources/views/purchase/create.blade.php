...
<section class="content">
	...
	@component('components.widget', ['class' => 'box-primary'])
		<div class="row">
			<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
				<div class="form-group">
					{!! Form::label('supplier_id', __('purchase.supplier') . ':*', ['class' => 'simple_text']) !!}
			...
			<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
				<div class="form-group">
					{!! Form::label('ref_no', __('purchase.ref_no').':', ['class' => 'simple_text']) !!}
			...
			<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
				<div class="form-group">
					{!! Form::label('transaction_date', __('purchase.purchase_date') . ':*', ['class' => 'simple_text']) !!}
					<div class="input-group">
						<span class="input-group-addon">
			...
			<div class="col-sm-3 @if(!empty($default_purchase_status)) hide @endif">
				<div class="form-group">
					{!! Form::label('status', __('purchase.purchase_status') . ':*', ['class' => 'simple_text']) !!} @show_tooltip(__('tooltip.order_status'))
			...
			<div class="col-sm-3">
				<div class="form-group">
					{!! Form::label('location_id', __('purchase.business_location').':*', ['class' => 'simple_text']) !!}
			...
			<div class="col-sm-3 @if(!$currency_details->purchase_in_diff_currency) hide @endif">
				<div class="form-group">
					{!! Form::label('exchange_rate', __('purchase.p_exchange_rate') . ':*', ['class' => 'simple_text']) !!}
			...
			<div class="col-sm-3">
                <div class="form-group">
                    {!! Form::label('document', __('purchase.attach_document') . ':', ['class' => 'simple_text']) !!}
		...
		@if(!empty($custom_field_1_label))
			...
			<div class="col-md-4">
		        <div class="form-group">
		            {!! Form::label('custom_field_1', $label_1, ['class' => 'simple_text']) !!}
		...
		@if(!empty($custom_field_2_label))
			...
			<div class="col-md-4">
		        <div class="form-group">
		            {!! Form::label('custom_field_2', $label_2, ['class' => 'simple_text']) !!}
		...
		@if(!empty($custom_field_3_label))
			...
			<div class="col-md-4">
		        <div class="form-group">
		            {!! Form::label('custom_field_3', $label_3, ['class' => 'simple_text']) !!}
		...
		@if(!empty($custom_field_4_label))
			...
			<div class="col-md-4">
		        <div class="form-group">
		            {!! Form::label('custom_field_4', $label_4, ['class' => 'simple_text']) !!}
		...
		<div class="row">
			<div class="col-sm-3">
				<div class="form-group">
					{!! Form::label('purchase_order_ids', __('lang_v1.purchase_order').':', ['class' => 'simple_text']) !!}
			...
			<div class="col-sm-12">
				<div class="table-responsive">
					<table class="table table-condensed table-bordered table-th-green text-center table-striped" id="purchase_entry_table">
						<thead>
							<tr>
								<th class="simple_text">#</th>
								<th class="simple_text">@lang( 'product.product_name' )</th>
								<th class="simple_text">@lang( 'purchase.purchase_quantity' )</th>
								<th class="simple_text">@lang( 'lang_v1.unit_cost_before_discount' )</th>
								<th class="simple_text">@lang( 'lang_v1.discount_percent' )</th>
								<th class="simple_text">@lang( 'purchase.unit_cost_before_tax' )</th>
								<th class="{{$hide_tax}} simple_text">@lang( 'purchase.subtotal_before_tax' )</th>
								<th class="{{$hide_tax}} simple_text">@lang( 'purchase.product_tax' )</th>
								<th class="{{$hide_tax}} simple_text">@lang( 'purchase.net_cost' )</th>
								<th class="simple_text">@lang( 'purchase.line_total' )</th>
								<th class="@if(!session('business.enable_editing_product_from_purchase')) hide @endif simple_text">
									@lang( 'lang_v1.profit_margin' )
								</th>
								<th class="simple_text">
				...
				<div class="pull-right col-md-5">
					<table class="pull-right col-md-12">
						<tr>
							<th class="col-md-7 text-right simple_text">@lang( 'lang_v1.total_items' ):</th>
							<td class="col-md-5 text-left">
								<span id="total_quantity" class="display_currency" data-currency_symbol="false"></span>
							</td>
						</tr>
						<tr class="hide">
							<th class="col-md-7 text-right simple_text">@lang( 'purchase.total_before_tax' ):</th>
							<td class="col-md-5 text-left">
						...
						<tr>
							<th class="col-md-7 text-right simple_text">@lang( 'purchase.net_total_amount' ):</th>
							<td class="col-md-5 text-left">
		...
		<div class="row">
			...
			<table class="table">
				<tr>
					<td class="col-md-3">
						<div class="form-group">
							{!! Form::label('discount_type', __( 'purchase.discount_type' ) . ':', ['class' => 'simple_text']) !!}
					...
					<td class="col-md-3">
						<div class="form-group">
						{!! Form::label('discount_amount', __( 'purchase.discount_amount' ) . ':', ['class' => 'simple_text']) !!}
					...
					<td class="col-md-3">
						<b class="simple_text">@lang( 'purchase.discount' ):</b>(-) 
				...
				<tr>
					<td>
						<div class="form-group">
						{!! Form::label('tax_id', __('purchase.purchase_tax') . ':', ['class' => 'simple_text']) !!}
					...
					<td>&nbsp;</td>
					<td>
						<b class="simple_text">@lang( 'purchase.purchase_tax' ):</b>(+) 
				...
				<tr>
					<td colspan="4">
						<div class="form-group">
							{!! Form::label('additional_notes',__('purchase.additional_notes'), ['class' => 'simple_text']) !!}
	...
	<div class="row">
		<div class="col-md-4">
			<div class="form-group">
			{!! Form::label('shipping_details', __( 'purchase.shipping_details' ) . ':', ['class' => 'simple_text']) !!}
			{!! Form::text('shipping_details', null, ['class' => 'form-control']); !!}
			</div>
		</div>
		<div class="col-md-4 col-md-offset-4">
			<div class="form-group">
				{!! Form::label('shipping_charges','(+) ' . __( 'purchase.additional_shipping_charges' ) . ':', ['class' => 'simple_text']) !!}
	...
	<div class="row">
			...
			@if(!empty($shipping_custom_label_1))
				...
				<div class="col-md-4">
			        <div class="form-group">
			            {!! Form::label('shipping_custom_field_1', $label_1, ['class' => 'simple_text']) !!}
			...
			@if(!empty($shipping_custom_label_2))
				...
				<div class="col-md-4">
			        <div class="form-group">
			            {!! Form::label('shipping_custom_field_2', $label_2, ['class' => 'simple_text']) !!}
			...
			@if(!empty($shipping_custom_label_3))
				...
				<div class="col-md-4">
			        <div class="form-group">
			            {!! Form::label('shipping_custom_field_3', $label_3, ['class' => 'simple_text']) !!}
			...
			@if(!empty($shipping_custom_label_4))
				...
				<div class="col-md-4">
			        <div class="form-group">
			            {!! Form::label('shipping_custom_field_4', $label_4, ['class' => 'simple_text']) !!}
			...
			@if(!empty($shipping_custom_label_5))
				...
				<div class="col-md-4">
			        <div class="form-group">
			            {!! Form::label('shipping_custom_field_5', $label_5, ['class' => 'simple_text']) !!}
		...
		<div class="row">
			...
			<div class="col-md-8 col-md-offset-4" id="additional_expenses_div" style="display: none;">
				<table class="table table-condensed">
					<thead>
						<tr>
							<th class="simple_text">@lang('lang_v1.additional_expense_name')</th>
							<th class="simple_text">@lang('sale.amount')</th>
						</tr>
					</thead>
					<tbody>
						<tr>
		...
		<div class="row">
			<div class="col-md-12 text-right">
				{!! Form::hidden('final_total', 0 , ['id' => 'grand_total_hidden']); !!}
						<b class="simple_text">@lang('purchase.purchase_total'): </b><span id="grand_total" class="display_currency" data-currency_symbol='true'>0</span>
			</div>
		</div>
	@endcomponent
	@component('components.widget', ['class' => 'box-primary', 'title' => __('purchase.add_payment')])
		<div class="box-body payment_row">
			<div class="row">
				<div class="col-md-12">
					<strong class="simple_text">@lang('lang_v1.advance_balance'):</strong> <span id="advance_balance_text">0</span>
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="pull-right"><strong class="simple_text">@lang('purchase.payment_due'):</strong> <span id="payment_due">0.00</span></div>
				</div>
			</div>
			<br>
			<div class="row">
