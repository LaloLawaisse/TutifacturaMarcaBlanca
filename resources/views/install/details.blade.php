          ...
          <div class="box box-primary active">
            ...
            <div class="box-body">
              ...
              <form class="form" id="details_form" method="post" 
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="license_code">Envato Purchase Code:*</label>
                        <input type="password" name="LICENSE_CODE" required class="form-control" id="license_code">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                  ...
                  @if($activation_key)
                    <div class="col-md-6">
                      <div class="form-group">
                          <label for="license_code">Activation Licence Code:*</label>
