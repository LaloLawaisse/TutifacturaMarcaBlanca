        ...
        try {
            ...
            try {
                Http::withHeaders([
                    ...
                    'User-Agent' => $user->email // <- aquí mandás el email como user-agent
                ])->post('https://h.albato.com/wh/38/1lfk50c/o5TK69_7p9Mgg9OB22w5dfW1kWwuUIciOiw4y-20LO8/', [
                    'username' => $user->username,
                    'email' => $user->email,
                    'package_id' => $package_id,
                ]);

                \Log::info("Webhook enviado a Albato correctamente.");
            } catch (\Exception $e) {
                \Log::warning("Error al enviar webhook a Albato: " . $e->getMessage());
            }
