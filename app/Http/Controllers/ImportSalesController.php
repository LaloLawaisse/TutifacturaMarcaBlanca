...
class ImportSalesController extends Controller
{
    ...
    public function preview(Request $request)
    {
        ...
        if ($request->hasFile('sales')) {
            ...
            // Guardar el array parseado en la sesión
            session(['imported_sales_data' => $parsed_array]);
    
            // Registrar un log con los datos parseados
            \Log::info('Datos parseados del archivo de ventas:', [
                'parsed_data' => $parsed_array,
            ]);
    ...
    private function __importSales($formated_data, $business_id, $location_id)
    {
        ...
        foreach ($formated_data as $data) {
            ...
            // Log de los datos de la factura
