                    ...
                    function ($row) use ($only_shipments, $is_admin, $sale_type) {
                        ...
                        if ($row->type == 'sell') {
                            if (auth()->user()->can('print_invoice')) {
                                $html .= '<li><a href="#" class="print-invoice" data-href="'.route('factura.proforma', [$row->id]).'"><i class="fas fa-print" aria-hidden="true"></i> '.__('lang_v1.print_invoice').'</a></li>
                            ...
                            $html .= '<li><a href="'.route('sell.serve', [$row->id]).'" target="_blank"><i class="fas fa-file-invoice"></i> '.__('Factura ARCA').'</a></li>';
                            
                            $html .= '<li>
                                <a href="#" class="btn-modal" 
                                    data-href="'.action([FacturaController::class, 'generarEnlaceFactura'], [$row->id]).'"
                                    data-container=".afip_modal">
                                    <i class="fas fa-file-invoice"></i> '.__('Enviar Factura Whatsapp').'
                                </a>
                            </li>';
